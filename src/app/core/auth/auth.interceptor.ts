...
export class AuthInterceptor implements HttpInterceptor {
            ...
            .pipe(catchError(
                (err) => {
                    ...
                    if (err instanceof HttpErrorResponse &&
                        err.status === 401 && this.isNonAuthUrl(req) &&
                        ...
                        if (!this.refreshTokenInProgress.value) {
                            ...
                            return this.authService.refreshToken()
                                ...
                                .pipe(switchMap(() => next.handle(this.addAuthorizationHeader(req))))
    ...
    private waitRefreshFinishing(next: HttpHandler, request: HttpRequest<unknown>): Observable<HttpEvent<unknown>> {
        return this.refreshTokenInProgress
            ...
            .pipe(filter(res => !res))
            .pipe(take(1))
            .pipe(switchMap(() => next.handle(this.addAuthorizationHeader(request))));
    }
